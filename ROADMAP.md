# ROADMAP — blackroadqi.com

> Product roadmap for BlackRoad QI
...
- [ ] Deploy index.html to blackroadqi.com
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroadqi.com with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: Amundson Research, Quantum Trinary, QI Engine
...
**Milestone**: First paying customer through blackroadqi.com.
...
**Milestone**: blackroadqi.com is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: quantum | Products: Amundson Research, Quantum Trinary, QI Engine*
