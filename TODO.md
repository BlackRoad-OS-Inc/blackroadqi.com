# TODO — blackroadqi.com

> Active tasks for BlackRoad QI

## [RC] Priority 1 — Ship Now

- [ ] [RC] Deploy live website to blackroadqi.com via Gematria/Caddy
...
- [ ] [RC] Write product landing copy for: Amundson Research, Quantum Trinary, QI Engine
